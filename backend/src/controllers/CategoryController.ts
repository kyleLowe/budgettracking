...
export const createCategory = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const newCategory = await CategoryServices.createCategory(name, subcategory, note);
...
export const updateCategory = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const checkExistingCategory = await CategoryServices.getCategory(categoryId);
